...
Installed curl by adding it to the command that's being run.

```
root@debian-8gb-hel1-docker:~# docker run -it ubuntu:latest sh -c 'apt-get update && apt-get install curl -y; echo "Input website:"; read website; echo "Searching.."; sleep 1; curl http://$website;'
...
Get:11 http://archive.ubuntu.com/ubuntu bionic-updates/restricted amd64 Packages [21.9 kB]
Get:12 http://archive.ubuntu.com/ubuntu bionic-updates/multiverse amd64 Packages [8734 B]
Get:13 http://archive.ubuntu.com/ubuntu bionic-updates/universe amd64 Packages [1295 kB]
Get:14 http://security.ubuntu.com/ubuntu bionic-security/restricted amd64 Packages [11.3 kB]
Get:15 http://security.ubuntu.com/ubuntu bionic-security/main amd64 Packages [682 kB]
Get:16 http://archive.ubuntu.com/ubuntu bionic-updates/main amd64 Packages [977 kB]
Get:17 http://archive.ubuntu.com/ubuntu bionic-backports/universe amd64 Packages [4227 B]
Get:18 http://archive.ubuntu.com/ubuntu bionic-backports/main amd64 Packages [2496 B]
Fetched 17.2 MB in 3s (5338 kB/s)
...
The following additional packages will be installed:
  ...
  libkeyutils1 libkrb5-26-heimdal libkrb5-3 libkrb5support0 libldap-2.4-2 libldap-common libnghttp2-14
  libpsl5 libroken18-heimdal librtmp1 libsasl2-2 libsasl2-modules libsasl2-modules-db libsqlite3-0
...
Fetched 4834 kB in 6s (856 kB/s)
